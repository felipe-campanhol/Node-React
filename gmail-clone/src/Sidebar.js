...
function Sidebar() {
  return (
    <div className="sidebar">
      ...
      <SidebarOption Icon={LabelImportantIcon} title="Important" number={817}/>
      <SidebarOption Icon={NearMeIcon} title="Sent" number={950}/>
      <SidebarOption Icon={NoteIcon} title="Drafts" number={45}/>
      <SidebarOption Icon={ExpandMoreIcon} title="More" number={233}/>
